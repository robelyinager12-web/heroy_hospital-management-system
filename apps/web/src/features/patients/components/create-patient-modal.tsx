      ...
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-slate-900 p-6 shadow-2xl">
        ...
        {tempPassword ? (
          <div className="space-y-3">
            <p className="text-sm text-emerald-400">Patient created successfully.</p>
            <p className="text-sm text-slate-300">
              Temporary password: <span className="font-mono text-white">{tempPassword}</span>
            </p>
            <p className="text-xs text-slate-500">Share this with the patient so they can log in and set their own password.</p>
            <button
              onClick={handleClose}
